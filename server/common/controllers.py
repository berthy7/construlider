...
from server.database.connection import get_session
from ..common.utils import decorators
from ..usuarios.usuario.managers import *
from ..usuarios.login.managers import *
...
class SuperController(RequestHandler):
    ...
    def set_user_condominio(self, condominio):
        self.set_secure_cookie('condominios', str(condominio))
    ...
    def get_current_condominio(self):
        ...
        return self.get_secure_cookie("condominios")
